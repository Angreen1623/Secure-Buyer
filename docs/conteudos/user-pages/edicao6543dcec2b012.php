    ...
    <body>
        ...
        <div class="wrapper">        
            ...
            <div class="content">
                ...
                $prod->setcod_produto(12);          //mudar no novo_produto
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=`JavaScript`>window.location.replace(`.  ./user-pages/edicao6543dcec2b012.php`);</script>";

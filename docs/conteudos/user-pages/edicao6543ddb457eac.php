    ...
    <body class="body">
        ...
        <div class="wrapper">        
            ...
            <div class="content">
                ...
                $prod->setcod_produto(16);          //mudar no novo_produto
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=`JavaScript`>window.location.replace(`.  ./user-pages/edicao6543ddb457eac.php`);</script>";

    ...
    <body class="body">
        ...
        <div class="wrapper">        
            ...
            <div class="content">
                ...
                $prod->setcod_produto(5);          //mudar no novo_produto
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=`JavaScript`>window.location.replace(`.  ./user-pages/edicao654405a18d156.php`);</script>";

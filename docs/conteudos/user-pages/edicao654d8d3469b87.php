        ...
        <div class="wrapper">        
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=\"JavaScript\">window.location.replace(\"../user-pages/edicao654d8d3469b87.php\");</script>";

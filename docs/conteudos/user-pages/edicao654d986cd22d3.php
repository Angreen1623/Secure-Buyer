        ...
        <div class="wrapper">        
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=\"JavaScript\">window.location.replace(\"../user-pages/edicao654d986cd22d3.php\");</script>";

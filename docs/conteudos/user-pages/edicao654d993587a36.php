        ...
        <div class="wrapper">        
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=\"JavaScript\">window.location.replace(\"../user-pages/edicao654d993587a36.php\");</script>";

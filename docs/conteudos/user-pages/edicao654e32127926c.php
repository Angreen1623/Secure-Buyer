        ...
        <div class="wrapper">        
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=\"JavaScript\">window.location.replace(\"../user-pages/edicao654e32127926c.php\");</script>";

        ...
        <div class="wrapper">        
            ...
            <?php
                ...
                if(isset($btnalterar)){
                    ...
                    echo "<script language=\"JavaScript\">window.location.replace(\"../user-pages/edicao654e67c67b566.php\");</script>";

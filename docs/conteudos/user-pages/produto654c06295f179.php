                            ...
                            <div class="more">
                                ...
                                foreach($cart->consultar() as $row){
                                 ...
                                 if (isset($codper) && isset($produto_comprado)) {
                                    ...
                                    if (empty($avaliacoes)) {
                                        // O usuário ainda não avaliou o produto, então permita a avaliação
                                        ...
                                        echo '<input type="radio" name="estrela" id="estrela5" value="5"><br><br>';
                                        ...
                                        // O usuário já avaliou o produto, exiba uma mensagem ou redirecione para onde desejar.
                                ...
                                <div class="rating-box">
                                    ...
                                    <div class="filter">
                                        <div class="filter-item">
                                            <div class="media">
                                                <h4 class="underline">Média de avaliações</h4>
